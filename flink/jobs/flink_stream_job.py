...
def run_flink_stream_job():
    ...
    # 3. Định nghĩa Bảng ĐÍCH (Postgres)
    # THỨ TỰ ĐÚNG LÀ: airline, sentiment, count, window_time
    t_env.execute_sql("""
    ...
    windowed_counts = tweets_table.filter(
        ...
        # SỬA LỖI: SẮP XẾP LẠI THỨ TỰ CHO KHỚP VỚI BẢNG SINK
        col("airline"),
    ...
    # 5. Gửi dữ liệu từ query vào Bảng ĐÍCH
